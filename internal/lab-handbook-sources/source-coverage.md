...
| Internal 去識別完整稿 | 已產生在 `internal/lab-handbook-sources/redacted-full-draft.md`，包含 165 個來源頁區塊，不作為學生頁面發布。 |
| 公開章節版 | 已由去識別完整稿切成第 1 到第 6 章，頁碼範圍完整覆蓋 001-165；公開頁不顯示 OCR 狀態、來源圖片檔名或 redaction 標記。 |
